...
require_once( get_stylesheet_directory() . '/includes/landing-page-nav-menus-class.php');
require_once( get_stylesheet_directory() . '/includes/widgets/landing-page-widgets-class.php');
require_once( get_stylesheet_directory() . '/includes/acf/landing-page-acf-class.php');

/**
 * Child Theme Nav Menus
 */

 if ( class_exists( 'LP_Nav_Menus' ) ) {
   new LP_Nav_Menus();
 }
...
function torque_enqueue_child_styles() {
    ...
    // enqueue child style
    wp_enqueue_style( 'landing-page-styles',
